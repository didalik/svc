...
async function sign (keypair) { // TODO better name for keypair {{{1
  console.error('- sign keypair.data2sign', keypair.data2sign)

  keypair.data2sign = keypair?.data2sign.toString() ?? await window.crypto.subtle.exportKey('raw', keypair.publicKey)
