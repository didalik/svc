...
async function USER_URL (data2sign, remoteStr, e) { // {{{1
  ...
  let text = await pGET.call(this,
    '/svc/user_url_stub', `?actorPK=${actorPK}`,
...
async function pGET_parms (remote, noget, role = 'OWNER', e = process.env) { // {{{1
  //console.error('- pGET_parms remote', remote, 'role', role, 'noget', noget, 'e', e)
...
export { // {{{1
  USER_URL, WS_USER_URL, generate_keypair, pGET, pGET_parms, signedData, verifyData,
}
